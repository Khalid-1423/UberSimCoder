            ...
            public void onClick(View v)
            {
                switch (status)
                {
                    case 1:
                        ...
                        //the driver is on his way to pickup the customer
                    ...
                    case 2:
                        ...
                        //the driver is on his way to the destination with the csutomer inside his car
...
//                    mCustomerProfileImage.setImageResource(R.drawable.person);
    ...
    private void getAssignedCustomerPickupLocation()
    {
        ...
        assignedCustomerPickupLocationRefListener =  assignedCustomerPickupLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            {
                //if data/location changes, this method is called
                ...
                if(dataSnapshot.exists() && !customerId.equals(""))
                {
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLatLng).title("pickup locationn").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_marker)));
...
//        routing.execute();
    ...
    private void  recordRide()
    {
        ...
        map.put("destinatiop",destination);
       ...
       public void onLocationResult(LocationResult locationResult)
       {
           for(Location location : locationResult.getLocations())
           {
               if(getApplicationContext()!=null)
               {
                   ...
                   {
                       case "":
                           //customerId is empty, that means driver don't need to pickup any customer
                           //no customer is assigned to him(driver)
