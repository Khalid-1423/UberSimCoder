...
import historyRecylerView.HistoryAdapter;
import historyRecylerView.HistoryObject;
...
public class HistoryActivity extends AppCompatActivity
{
    ...
    {
        DatabaseReference userHistoryDatabse = FirebaseDatabase.getInstance().getReference()
                .child("Users").child(customerOrDriver).child(userId).child("history");

        userHistoryDatabse.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
